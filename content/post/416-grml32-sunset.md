...
Users really needing grml32 due to lack of 64-bit support of their hardware can continue to use Grml 2024.02, which will be the last release with a grml32 build. However, we encourage users to migrate to a more modern, possibly second-hand, hardware instead.
